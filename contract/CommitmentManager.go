...
//
// Solidity: event SendDACommitment((uint256,uint256) commitment, uint256 timestamp, uint256 nonce, uint256 index, uint256 len, bytes32 nodeGroupKey, uint256 nameSpaceId, bytes[] signatures)
