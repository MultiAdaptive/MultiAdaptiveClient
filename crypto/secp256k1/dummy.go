...
import (
	_ "domiconexec/crypto/secp256k1/libsecp256k1/include"
	_ "domiconexec/crypto/secp256k1/libsecp256k1/src"
	_ "domiconexec/crypto/secp256k1/libsecp256k1/src/modules/recovery"
)
