...
func (ec *Client) ChainID(ctx context.Context) (*big.Int, error) {
	...
	err := ec.c.CallContext(ctx, &result, "mta_chainId")
	if err != nil {
		return nil, err
	}
...
func (ec *Client) BlockByHash(ctx context.Context, hash common.Hash) (*types.Block, error) {
	return ec.getBlock(ctx, "mta_getBlockByHash", hash, true)
}
...
func (ec *Client) BlockByNumber(ctx context.Context, number *big.Int) (*types.Block, error) {
	return ec.getBlock(ctx, "mta_getBlockByNumber", toBlockNumArg(number), true)
}

// BlockNumber returns the most recent block number
func (ec *Client) BlockNumber(ctx context.Context) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, "mta_blockNumber")
...
func (ec *Client) BlockReceipts(ctx context.Context, blockNrOrHash rpc.BlockNumberOrHash) ([]*types.Receipt, error) {
	var r []*types.Receipt
	err := ec.c.CallContext(ctx, &r, "mta_getBlockReceipts", blockNrOrHash.String())
	if err == nil && r == nil {
	...
	if len(body.UncleHashes) > 0 {
		...
		for i := range reqs {
			reqs[i] = rpc.BatchElem{
				Method: "mta_getUncleByBlockHashAndIndex",
...
func (ec *Client) HeaderByHash(ctx context.Context, hash common.Hash) (*types.Header, error) {
	var head *types.Header
	err := ec.c.CallContext(ctx, &head, "mta_getBlockByHash", hash, false)
	if err == nil && head == nil {
...
func (ec *Client) HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error) {
	var head *types.Header
	err := ec.c.CallContext(ctx, &head, "mta_getBlockByNumber", toBlockNumArg(number), false)
	if err == nil && head == nil {
		err = ethereum.NotFound
	}
	return head, err
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	err = ec.c.CallContext(ctx, &json, "mta_getTransactionByHash", hash)
	if err != nil {
...
func (ec *Client) TransactionCount(ctx context.Context, blockHash common.Hash) (uint, error) {
	...
	err := ec.c.CallContext(ctx, &num, "mta_getBlockTransactionCountByHash", blockHash)
	return uint(num), err
}
...
func (ec *Client) SendDAByParams(ctx context.Context, sender common.Address,index,length uint64,commitment,data []byte,nodeGroupKey [32]byte,proof []byte,claimedValue []byte,outTimeStamp int64) ([]byte, error) {
	var result []byte
	err := ec.c.CallContext(ctx, &result, "mta_sendDAByParams", sender, index, length, commitment, data, nodeGroupKey,proof,claimedValue,outTimeStamp)
	return result, err
}
...
func (ec *Client) SendBTCDAByParams(ctx context.Context,commitment ,data []byte,nodeGroupKey [32]byte,proof []byte,claimedValue []byte,revealTxBytes, commitTxBytes, inscriptionScript []byte) ([]byte, error) {
	var result []byte
	err := ec.c.CallContext(ctx, &result, "mta_sendBTCDAByParams", commitment, data, nodeGroupKey, proof,claimedValue,revealTxBytes,commitTxBytes,inscriptionScript)
	return result, err
}
...
func (ec *Client) SendBatchDAs(ctx context.Context, datas [][]byte) ([][]byte, error) {
	...
	err := ec.c.CallContext(ctx, res, "mta_sendBatchDAs", datas)
...
func (ec *Client) GetDAByHash(ctx context.Context, hash common.Hash) (RPCDA, error) {
	...
	err := ec.c.CallContext(ctx, &fd, "mta_getDAByHash", hash)
	return fd, err
}
...
func (ec *Client) GetDAByCommitment(ctx context.Context, commitment string) (RPCDA, error) {
	...
	err := ec.c.CallContext(ctx, &fd, "mta_getDAByCommitment", commitment)
	return fd, err
}
...
func (ec *Client) GetBatchDAByCommitments(ctx context.Context, commitments rpc.Commitments) (RPCDAs, error) {
	...
	err := ec.c.CallContext(ctx, &res, "mta_getBatchDAByCommitments", commitments.Commits)
	return res, err
}
...
func (ec *Client) TransactionInBlock(ctx context.Context, blockHash common.Hash, index uint) (*types.Transaction, error) {
	var json *rpcTransaction
	err := ec.c.CallContext(ctx, &json, "mta_getTransactionByBlockHashAndIndex", blockHash, hexutil.Uint64(index))
	if err != nil {
		return nil, err
	}
	if json == nil {
...
func (ec *Client) TransactionReceipt(ctx context.Context, txHash common.Hash) (*types.Receipt, error) {
	var r *types.Receipt
	err := ec.c.CallContext(ctx, &r, "mta_getTransactionReceipt", txHash)
	if err == nil {
		if r == nil {
			return nil, ethereum.NotFound
		}
...
func (ec *Client) CodeAt(ctx context.Context, account common.Address, blockNumber *big.Int) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &result, "mta_getCode", account, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) NonceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, "mta_getTransactionCount", account, toBlockNumArg(blockNumber))
	return uint64(result), err
}
...
func (ec *Client) FilterLogs(ctx context.Context, q ethereum.FilterQuery) ([]types.Log, error) {
	...
	err = ec.c.CallContext(ctx, &result, "mta_getLogs", arg)
	return result, err
}
...
func (ec *Client) CallContract(ctx context.Context, msg ethereum.CallMsg, blockNumber *big.Int) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &hex, "mta_call", toCallArg(msg), toBlockNumArg(blockNumber))
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg ethereum.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(ctx, &hex, "mta_call", toCallArg(msg), rpc.BlockNumberOrHashWithHash(blockHash, false))
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) EstimateGas(ctx context.Context, msg ethereum.CallMsg) (uint64, error) {
	...
	err := ec.c.CallContext(ctx, &hex, "mta_estimateGas", toCallArg(msg))
	if err != nil {
		return 0, err
	}
...
func (ec *Client) SendTransaction(ctx context.Context, tx *types.Transaction) error {
	...
	return ec.c.CallContext(ctx, nil, "mta_sendRawTransaction", hexutil.Encode(data))
}
