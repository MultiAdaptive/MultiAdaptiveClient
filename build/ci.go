...
import (
	...
	"domiconexec/common"
	"domiconexec/crypto/signify"
	"domiconexec/internal/build"
	"domiconexec/params"
)
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "domiconexec/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "domiconexec/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "domiconexec/params.gitTag="+env.Tag)
	}
