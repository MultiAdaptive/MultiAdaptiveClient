...
type BaseTransaction struct {
	...
	Hex             string  `gorm:"column:f_hex;not null;comment:交易;uniqueIndex:uniq_transaction_hex" json:"hex"`                                          //交易
	Txid            string  `gorm:"column:f_txid;not null;comment:交易编号;uniqueIndex:uniq_transaction_txid" json:"txid"`                                     //交易编号
	TransactionHash string  `gorm:"column:f_transaction_hash;not null;comment:交易哈希;uniqueIndex:uniq_transaction_transaction_hash" json:"transaction_hash"` // 交易哈希
