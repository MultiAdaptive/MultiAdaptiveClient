...
func SetupGenesisBlockWithOverride(db ethdb.Database, triedb *trie.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case ghash == params.MultiAdaptiveGenesisHash:
		return params.MultiAdaptivenetConfig
	default:
...
func DefaultMultiAdaptiveGenesisBlock() *Genesis {
	return &Genesis{
		Config:params.MultiAdaptivenetConfig,
		Nonce:      0,
		ExtraData:  []byte("MultiAdaptive !"),
		GasLimit:   5000,
		Difficulty: big.NewInt(17179869184),
		//Alloc:      decodePrealloc(mainnetAllocData),
	}
