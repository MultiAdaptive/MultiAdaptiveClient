...
// and Processor.
func NewBlockChain(db ethdb.Database, cacheConfig *CacheConfig, genesis *Genesis,sqlDb *gorm.DB) (*BlockChain, error) {
	if cacheConfig == nil {
	...
	log.Info("genesisBlock----hash","blockHash",bc.genesisBlock.Hash().Hex())
